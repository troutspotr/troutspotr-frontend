...
const actionHandlers = {
  ...
  'MAP_CAMERA_SET_PIXEL_BUFFER': (state, {'payload': {pixelBuffer}}) => ({...state, 'pixelBuffer': clamp(pixelBuffer, 0, 500)}),
  ...
  'MAP_CAMERA_SET_ANIMATION_SPEED': (state, {'payload': {animationSpeed}}) => ({...state, 'animationSpeed': clamp(animationSpeed, 0.00001, 5)}),
}
