...
import { IRestrictionComponent, RestrictionComponent } from './Restriction.component';
import { MessageOverlayComponent } from '../../messageOverlay/MessageOverlay.component';
const stories = storiesOf('Restriction Component', module)
...
stories.add('basic', () => {
  ...
  return <RestrictionComponent {...props} />
})
