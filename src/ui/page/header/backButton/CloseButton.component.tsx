        ...
        <svg width="44" height="44" viewBox="0 0 44 44" onClick={onClick} className={classes.svg}>
          ...
          <g id="Canvas" transform="translate(515 229)">
            <g id="Close Button Lg">
              <g id="Ellipse">
                <mask id="close_mask0_outline_out">
                  <rect
                  ...
                  <g className={classes.backdrop}>
                    <use
                      xlinkHref="#close_path0_fill"
                      fill="black"
                      transform="translate(-512 -226)"
                    />
                  </g>
                </mask>
                <g mask="url(#close_mask0_outline_out)" className={classes.circle}>
                  <use xlinkHref="#clos_path1_stroke_2x" transform="translate(-512 -226)" />
                </g>
              </g>
              <g id="Vector" className={classes.chevron}>
                <use xlinkHref="#close_path2_stroke" transform="translate(-504 -218)" />
              </g>
              <g id="Vector 2" className={classes.chevron}>
                <use xlinkHref="#close_path3_stroke" transform="translate(-504 -218)" />
              </g>
            </g>
          </g>
          <defs>
