...
import * as regionSelectors from 'ui/routes/_state/_region/Region.selectors'
import { displayedStreamCentroidDataSelector } from 'ui/routes/_state/State.selectors'
...
export const STREAM_ACCESS_POINTS_LETTER_ACTIVE_LAYER_ID =
  'stream-access-points-letter-active-layer'
export const STREAM_ACCESS_POINTS_LETTER_QUITE_LAYER_ID = 'stream-access-points-letter-quiet-layer'

export const STREAM_ACCESS_POINTS_MARKER_BORDER_ACTIVE_LAYER_ID =
  'stream-access-points-marker-border-active-layer'
export const STREAM_ACCESS_POINTS_MARKER_BORDER_QUITE_LAYER_ID =
  'stream-access-points-marker-border-quiet-layer'

export const STREAM_ACCESS_POINTS_MARKER_CENTER_ACTIVE_LAYER_ID =
  'stream-access-points-marker-center-active-layer'
export const STREAM_ACCESS_POINTS_MARKER_CENTER_QUITE_LAYER_ID =
  'stream-access-points-marker-center-quiet-layer'
...
export const getSelectedStreamFilter = createSelector(
  [regionSelectors.visibleTroutStreamIdsSelector, displayedStreamCentroidDataSelector],
  (visibleIds, displayedStreamCentroid) => {
...
export const getStreamsActiveFilter = createSelector(
  ...
  visibleTroutStreamIds => ['in', 'gid'].concat(visibleTroutStreamIds)
)
...
export const getDerivedFeatureActiveFilter = createSelector(
  [getSelectedStreamFilter],
  visibleTroutStreamIds => ['in', 'stream_gid'].concat(visibleTroutStreamIds)
)
...
const STREAM_ACCESS_POINT_ACTIVE_FILTER_BASE = [
  'all',
  ['==', '$type', 'Point'],
  ['any', ['==', 'bridgeType', 'publicTrout'], ['==', 'bridgeType', 'permissionRequired']],
]
...
export const getAccessPointActiveFilter = createSelector(
  [getSelectedStreamFilter, getDerivedFeatureActiveFilter],
...
export const getAccessPointQuietFilter = createSelector(
  [getSelectedStreamFilter, getDerivedFeatureQuietFilter],
