...
export const StreamCentroidsActiveStyle = {
  ...
  layout: {
    ...
    'text-size': {
      base: 1,
      stops: [
        [CENTROID_LABEL_MIN_ZOOM, CENTROID_LABEL_TEXT_SIZE - 5],
        [CENTROID_LABEL_MIN_ZOOM + 1, CENTROID_LABEL_TEXT_SIZE],
        [CENTROID_LABEL_MIN_ZOOM + 3, CENTROID_LABEL_TEXT_SIZE + 2],
      ],
    },
  ...
  paint: {
    'text-opacity': {
      base: 1,
      stops: [
        [CENTROID_LABEL_MIN_ZOOM, 0.1],
        [CENTROID_LABEL_MIN_ZOOM + 1, 0.5],
        [CENTROID_LABEL_MIN_ZOOM + 3, 0.7],
      ],
    },
