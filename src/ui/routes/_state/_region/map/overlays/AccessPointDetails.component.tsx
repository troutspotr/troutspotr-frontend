...
import AccessPointComponent from 'ui/routes/_state/_region/_stream/details/AccessPoint.component'
...
const AccessPointClasses = require('ui/routes/_state/_region/_stream/details/Details.scss')
